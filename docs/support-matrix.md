...
| Qwen3.8 | Supported (CUDA) | `unsloth/Qwen3.8-27B-NVFP4` — mixed-precision: NVFP4 MLP (W4AFP8) + FP8 per-channel attention, same `qwen3_5` architecture as Qwen3.5/3.6. Loads in 6.5s on H20, 20.69 GiB peak RSS, 9.3 tok/s decode at c=1, FP8 KV cache ([wins](experience/wins/2026-08-18-qwen38-27b-nvfp4-inference.md)). |
