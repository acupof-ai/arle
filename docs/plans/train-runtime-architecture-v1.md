...
- ✅ End-to-end 2-step SFT smoke test — CUDA remote validation landed on 2026-04-21 for the current Qwen-family train path (`train_sft -> eval_lm -> arle -> resume` on `Qwen3-0.6B` and the generic dense/full-attn Qwen3.5-family flow). See `docs/experience/wins/2026-04-21-cuda-train-e2e-validation.md`.
