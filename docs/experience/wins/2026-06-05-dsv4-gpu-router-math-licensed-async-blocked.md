...
[`reference_disabled_event_tracking_premature_buffer_free`](../../../.claude/projects/-Users-user-code-agent-infer/memory/reference_disabled_event_tracking_premature_buffer_free.md):
