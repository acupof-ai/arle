...
11 commits, 65 files, **−7,155 / +85** (net −7,070 lines). Every deletion
verified as zero-caller before removal; no live path touched.
...
| FFI + .cu dead kernels | cuda-kernels | 24 stale GDR FFI declarations, 3 dead .cu files (fused_attention, w4_fp8/w4a8 activation quant), dequant_paged_kv dead half, 2 test-only quant FFI + tests | 1,278 |
