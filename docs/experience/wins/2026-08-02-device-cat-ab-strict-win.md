...
**Date:** 2026-08-02 · **Commit:** · **Pod:** 8×H20, real 27B cp=2

## Context

 made `ops::cat` device-lazy (D2D concat, no host round-trip) for the
...
|-----|--------------|-----|-----|------|--------|
| device-cat (HEAD) | 46.2 GB | 102.6 s | 386.5 s | 0 | 4.805667 / 6.064441 |
| host-cat (pre-) | 56.8 GB | 670.0 s | 2054.1 s | done, marker unwritten | identical |
