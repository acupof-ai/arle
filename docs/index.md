...
| Path | Status | Use this when |
| --- | --- | --- |
| [plans/2026-07-10-operator-artifact-dev-release-system.md](plans/2026-07-10-operator-artifact-dev-release-system.md) | Active design — ideal operator platform | The question is how ARLE converges on one generated operator graph, evidence-driven dispatch, explicit kernel builds, OCI/CAS artifacts, a minimal developer loop, or zero-compile GitHub Release products. |
