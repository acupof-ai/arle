...
| `infer-quant` | Host-only weight-quant checkpoint ABI: `QuantFormat`, `QuantManifest`, `detect_quant_format`, scale-shape validation, FP8 E4M3 codec. Zero device calls. | Kernels, device dequant math, scheduler |
