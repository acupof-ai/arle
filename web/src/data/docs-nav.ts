...
export const DOCS_NAV: DocsGroup[] = [
  {
    heading: "Get started",
    links: [
      { label: "Introduction", href: "https://github.com/acupof-ai/arle/blob/main/README.md" },
  ...
  },
  {
    heading: "Concepts",
    links: [
      { label: "Front door & verbs", href: "https://github.com/acupof-ai/arle/tree/main/crates/cli" },
      { label: "Runtime spine", href: "https://github.com/acupof-ai/arle/tree/main/crates/infer-core" },
      { label: "Backend dispatch", href: "https://github.com/acupof-ai/arle/tree/main/crates/infer-seam" },
      { label: "Stability levels", href: "https://github.com/acupof-ai/arle/blob/main/docs/stability-policy.md" },
    ],
  },
  {
    heading: "Run",
  ...
  },
  {
    heading: "Backends",
    links: [
      { label: "CUDA", href: "https://github.com/acupof-ai/arle/tree/main/crates/cuda-kernels" },
      { label: "Metal", href: "https://github.com/acupof-ai/arle/tree/main/crates/mlx-sys", badge: "beta" },
      { label: "CPU", href: "https://github.com/acupof-ai/arle/blob/main/docs/support-matrix.md" },
      { label: "Kernel crates", href: "https://github.com/acupof-ai/arle/tree/main/crates", badge: "new" },
    ],
  },
  {
    heading: "Operate",
    links: [
      { label: "Environment vars", href: "https://github.com/acupof-ai/arle/blob/main/docs/environment.md" },
      { label: "Metrics", href: "https://github.com/acupof-ai/arle/blob/main/docs/http-api.md" },
      { label: "Sessions", href: "https://github.com/acupof-ai/arle/blob/main/docs/http-api.md" },
      { label: "Logs & tracing", href: "https://github.com/acupof-ai/arle/blob/main/docs/environment.md" },
    ],
  },
];
