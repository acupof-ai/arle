...
pub(crate) struct DeepseekAttentionRuntimeCache {
    ...
    pub(crate) fm_decode_tp_gathered_q: Option<CudaSlice<bf16>>,
    pub(crate) fm_decode_tp_packed_q: Option<CudaSlice<bf16>>,
    pub(crate) fm_decode_tp_full_out: Option<CudaSlice<bf16>>,
