...
- **MANDATORY — every runtime change produces a bench entry.** A diff isn't
 ...
 project/plan.
- Snapshot to `YYYY-MM-DD-bench-<label>.md` using
...
- **Canonical tool: `scripts/bench_throughput.py`** — the repo-native
 ...
 `docs/bench-and-trace-spec.md`; changing them is a
...
- `docs/architecture.md` — final `cuda-kernels` extraction blueprint (trip wires + acceptance).
