...
mod app {
    ...
    pub fn main() -> Result<()> {
        ...
        autograd::apply_runtime_flags(&autograd::AutogradRuntimeFlags {
            ...
            fp8_native_gemm: args.fp8_native_gemm,
            ..Default::default()
        });
        ...
        println!(
            "qwen36_fp8_lora_fd_gate_start model={} device={} rank={} alpha={:.6} \
             ...
             freeze_base_routes={} sparse_logit_probe={} gdr_chunkwise={} fp8_native_gemm={}",
            args.model.display(),
            args.device,
            args.lora.rank,
            args.lora.alpha,
    ...
    fn parse_args() -> Result<Args> {
        ...
        while let Some(arg) = args.next() {
            match arg.as_str() {
                ...
                "--fp8-native-gemm" => fp8_native_gemm = true,
                "--prompt-len" => {
