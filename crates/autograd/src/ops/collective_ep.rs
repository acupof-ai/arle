...
//!
//! This module owns the verified host kernel (apply S / apply Sᵀ) + a CPU
//! round-trip gate. The NCCL all-to-all transport that moves rows across ranks is
//! the pending-remote integration boundary (world==1 = identity, CPU-testable).
