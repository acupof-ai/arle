        ...
        match relay.recv()? {
            ...
            Some(RelayEnvelope::StatsQuery { request_id }) => {
                ...
                let data = WireStats {
                    ...
                    throughput_requests_succeeded: throughput.requests_succeeded,
                    throughput_requests_failed: throughput.requests_failed,
                    throughput_ttft_micros_total: throughput.ttft_micros_total,
                    throughput_ttft_count: throughput.ttft_count,
                    throughput_tpot_micros_total: throughput.tpot_micros_total,
                    throughput_tpot_count: throughput.tpot_count,
                    throughput_e2e_micros_total: throughput.e2e_micros_total,
                    throughput_e2e_count: throughput.e2e_count,
                    ...
                    kv_tier_page_blocks_measured: tier.page_blocks_measured,
                    ...
                    kv_system_residency_measured: system.residency_measured,
