// Requantize ARLE's 1-byte quantized KV planes (FP8 e4m3 or INT8,
// per-(token, kv_head) f32 scales) into the FA3 fp8 operand format: e4m3 with
// one descale per (batch row, kv_head).
//
// Entry points:
