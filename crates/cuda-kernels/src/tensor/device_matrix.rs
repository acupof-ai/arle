...
pub struct DeviceMatrix {
    ...
    /// A LoRA merge promoted this NVFP4 weight out of its Marlin layout. The
    /// tiles move here rather than being freed, because a `--share-frozen-base`
    /// student aliases them; parking them out of `marlin_packed` is what keeps
    /// the FP8 serving arm from reading FP4 tiles as FP8 after the requant.
    pub retired_marlin: Option<(CudaSlice<u8>, CudaSlice<u16>)>,
