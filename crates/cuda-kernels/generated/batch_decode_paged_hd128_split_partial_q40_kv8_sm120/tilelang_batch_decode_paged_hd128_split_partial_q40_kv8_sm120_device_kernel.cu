  ...
  *(float2*)(l_i + 0) = make_float2(broadcast_var_2, broadcast_var_2);
  ...
  for (int i_1 = 0; i_1 < 8; ++i_1) {
    ...
    if (((((i_1 * 8) + (((int)threadIdx.x) >> 4)) == 0) && (((int)blockIdx.x) < total_q_tokens_3))) {
      condval_3 = *(uint4*)(Q + (((((int64_t)((int)blockIdx.x)) * (int64_t)5120) + (((int64_t)((int)blockIdx.y)) * (int64_t)128)) + ((((int64_t)((int)threadIdx.x)) & (int64_t)15) * (int64_t)8)));
    } else {
    ...
    for (int i_14 = 0; i_14 < 32; ++i_14) {
      if (((((((int)threadIdx.x) >> 5) * 16) + ((i_14 & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)) == 0) {
        if (((int)blockIdx.z) < num_splits_1) {
          ...
          *(float2*)(Partial_out + (((((((int64_t)((int)blockIdx.x)) * (int64_t)5120) + ((((int64_t)((int)blockIdx.z)) * ((int64_t)total_q_tokens)) * (int64_t)5120)) + (((int64_t)((int)blockIdx.y)) * (int64_t)128)) + ((((int64_t)i_14) >> (int64_t)1) * (int64_t)8)) + ((((int64_t)((int)threadIdx.x)) & (int64_t)3) * (int64_t)2))) = condval_9;
        }
      }
    }
  }
      ...
      if (((((((int)threadIdx.x) >> 5) * 16) + (i_15 * 8)) + ((((int)threadIdx.x) & 31) >> 2)) == 0) {
        if (((int)blockIdx.x) < total_q_tokens_2) {
          if (((int)blockIdx.z) < num_splits_3) {
            Partial_m[(((((int64_t)((int)blockIdx.x)) * (int64_t)40) + ((((int64_t)((int)blockIdx.z)) * ((int64_t)total_q_tokens_2)) * (int64_t)40)) + ((int64_t)((int)blockIdx.y)))] = m_i[i_15];
          }
        }
        if (((int)blockIdx.x) < total_q_tokens_1) {
          if (((int)blockIdx.z) < num_splits_2) {
            Partial_l[(((((int64_t)((int)blockIdx.x)) * (int64_t)40) + ((((int64_t)((int)blockIdx.z)) * ((int64_t)total_q_tokens_1)) * (int64_t)40)) + ((int64_t)((int)blockIdx.y)))] = l_i[i_15];
          }
        }
      }
    }
