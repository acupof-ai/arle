...
//! [`crate::moe::moe_forward_into`]'s two `moe_bf16_grouped_gemm_*` calls — a follow-up.
...
use crate::ops::{
    ...
    silu_mul_fused, split_qkv, split2, upload_i32, warm_fp4_deepgemm_dense,
...
mod tests {
    ...
    /// mandatory. Panics when mandatory; returns (skip) otherwise. The skip
