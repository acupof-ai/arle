...
// The per-page entry codec + layer state live in infer-kvspace (backend-neutral,
// tested on Mac); re-exported here so `crate::attention::` paths stay stable.
pub(crate) use infer_kvspace::{Dsv4LayerPageState, Dsv4PrefixPageEntry};
