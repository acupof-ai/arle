...
description: Replace user-home absolute paths with repo ids, $HOME-based paths, or generic placeholders before commit
type: feedback
---

User-facing or committed docs must not contain workstation-specific absolute
paths like `<absolute-user-path>/...`.
...
user-home absolute path prefixes and replace:
